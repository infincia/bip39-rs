...
pub fn generate_12_english() {
    test_word_count(12);
}

pub fn generate_15_english() {
    test_word_count(15);
}

pub fn generate_18_english() {
    test_word_count(18);
}

pub fn generate_21_english() {
    test_word_count(21);
}

pub fn generate_24_english() {
    test_word_count(24);
}

pub fn generate_from_invalid_entropy() {
    // 15 bytes
